...
def get_boxes_image(boxes, segms=None, keypoints=None, thresh=0.9, dataset=None):
    ...
    for i in sorted_inds:
        ...
        if score < thresh:
            continue
        tmp_list = []
        class_name = get_class(classes[i], dataset)
        tmp_list.append(class_name)
        tmp_list.append(bbox[0])
        tmp_list.append(bbox[1])
        tmp_list.append(bbox[2] - bbox[0])
        tmp_list.append(bbox[3] - bbox[1])
        # show box (off by default)
